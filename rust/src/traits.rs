...
///
/// This is the foundation of a coordinate transformation,
/// but can also represent
/// e.g. an N-D array for the Coordinates and Displacement transforms to index into.
...
pub trait ValueProvider<T>: std::fmt::Debug + Send + Sync {
    ...
    fn bulk_get(&self, coords: &[&[f64]], buf: &mut [T]) {
    ...
    fn column_get(&self, columns: &[&[f64]], buf: &mut [T]) {
